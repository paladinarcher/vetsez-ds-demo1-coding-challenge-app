...
function StatesInput({name, label, onChange, onBlur} = {}) {
    const statesOptions = [ 
    ...
    return (<FormCombobox name={name || "state"} label={label || "State"} options={statesOptions} autoselect={true} onChange={onChange} onBlur={onBlur} />)
}
